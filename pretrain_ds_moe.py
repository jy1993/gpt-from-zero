...
parser.add_argument('--init_from_dense', action='store_true')
...
def main():
	...
	model = GPT(config)
	print(model)
	if args.init_from_dense:
		model = load_dense_weight_for_moe(model, args.model_path, config)
	...
	if args.task == 'pretrain':
		...
		train_dataset = dataset_wanjuan_en_dict['train']
		val_dataset = dataset_wanjuan_en_dict['validation']
